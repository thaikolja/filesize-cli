...
- Professionalized README with cleaner structure and formatting ([8a55de8](https://github.com/thaikolja/filesize-cli/commit/8a55de8))
- Removed broken CI/CD and Codecov badges (workflows no longer in the repository) ([8a55de8](https://github.com/thaikolja/filesize-cli/commit/8a55de8))
- Added PyPI Downloads badge to README ([8a55de8](https://github.com/thaikolja/filesize-cli/commit/8a55de8))
- Removed excessive emojis from documentation ([8a55de8](https://github.com/thaikolja/filesize-cli/commit/8a55de8))
- Simplified the installation section to focus on working methods ([8a55de8](https://github.com/thaikolja/filesize-cli/commit/8a55de8))
- Consolidated command reference tables ([8a55de8](https://github.com/thaikolja/filesize-cli/commit/8a55de8))
- Restructured changelog format ([8a55de8](https://github.com/thaikolja/filesize-cli/commit/8a55de8))
- Updated pyproject.toml version to 2.2.0 ([8a55de8](https://github.com/thaikolja/filesize-cli/commit/8a55de8))
- Updated all dev dependencies to latest versions ([8a55de8](https://github.com/thaikolja/filesize-cli/commit/8a55de8))
- Added Python 3.13 to classifiers and tool configurations ([8a55de8](https://github.com/thaikolja/filesize-cli/commit/8a55de8))
- Removed unused mypy overrides section for tests ([8a55de8](https://github.com/thaikolja/filesize-cli/commit/8a55de8))
- Updated setuptools requirement to >=75.0 ([8a55de8](https://github.com/thaikolja/filesize-cli/commit/8a55de8))

### Fixed

- Resolved mypy unused section warning ([8a55de8](https://github.com/thaikolja/filesize-cli/commit/8a55de8))
- Fixed test environment after dependency updates ([8a55de8](https://github.com/thaikolja/filesize-cli/commit/8a55de8))

### Chore

- Verified all tests pass (36 passed, 1 skipped) ([8a55de8](https://github.com/thaikolja/filesize-cli/commit/8a55de8))
- Confirmed 93.14% test coverage (above 90% threshold) ([8a55de8](https://github.com/thaikolja/filesize-cli/commit/8a55de8))
- Updated mypy python_version to 3.13 ([8a55de8](https://github.com/thaikolja/filesize-cli/commit/8a55de8))
- Updated black target-version to include py313 ([8a55de8](https://github.com/thaikolja/filesize-cli/commit/8a55de8))
